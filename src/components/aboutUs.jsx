          ...
          <div>
            <div className="flex flex-col py-20 ">
              <div className="items-center flex sm:justify-center">
                ...
                <h1 className="px-4 text-right text-8xl text-brown font-HandWriteTitle  sm:text-[70px]">О нас</h1>
                <div className="w-20 border-[1px] border-solid border-brown bg-brown h-1 sm:w-10 lp:w-8" />
              </div>
              <div className="font-Main">
                <div>
                  <p className="text-brownLight pt-2 pb-8 font-bold  text-[25px] sm:text-[20px] text-center mb-8">Причины стать нашим клиентом</p>
                </div>
                <div className="grid grid-flow-col">
                  ...
                  <ul className="text-[25px] text-main leading-[50px] sm:text-[18px] ">
